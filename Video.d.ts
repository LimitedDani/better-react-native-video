...
export interface AdEventType {
    event: "AD_BREAK_ENDED" | "AD_BREAK_READY" | "AD_BREAK_STARTED" | "AD_BUFFERING" | "AD_CAN_PLAY" | "AD_METADATA" | "AD_PERIOD_ENDED" | "AD_PERIOD_STARTED" | "AD_PROGRESS" | "ALL_ADS_COMPLETED" | "CLICK" | "COMPLETE" | "COMPLETED" | "CONTENT_PAUSE_REQUESTED" | "CONTENT_RESUME_REQUESTED" | "CUEPOINTS_CHANGED" | "DURATION_CHANGE" | "FIRST_QUARTILE" | "IMPRESSION" | "INTERACTION" | "LINEAR_CHANGED" | "LOADED" | "LOG" | "MIDPOINT" | "PAUSED" | "RESUMED" | "SKIPPABLE_STATE_CHANGED" | "SKIPPED" | "STARTED" | "STREAM_LOADED" | "TAPPED" | "THIRD_QUARTILE" | "UNKNOWN" | "USER_CLOSE" | "VIDEO_CLICKED" | "VIDEO_ICON_CLICKED" | "VOLUME_CHANGED" | "VOLUME_MUTED",
}
...
export interface VideoProperties extends ViewProps {
    ...
    onReceiveAdEvent?(data: AdEventType): void;
}
